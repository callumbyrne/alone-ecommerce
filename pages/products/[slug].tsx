...
const ProductDetails = ({ product, carouselProducts, variants }: Props) => {
  ...
  return (
    <div>
      <div className="lg:mx-10 lg:mb-20 lg:flex">
        <div id="main and preview" className="lg:w-2/3">
          {/* Main image */}
          <div className="flex justify-center">
            <div className="relative h-[300px] w-full md:w-[450px]">
              <Image
        ...
        {/* Details */}
        <div
          id="details and varitants"
          className="lg:w-1/3 lg:border-l lg:border-gray-400"
        >
          <div className="mx-7 mb-10">
            <h2 className="text-2xl font-extrabold tracking-wider">
              {product.name}
            </h2>
            <h3 className="text-md pb-3 font-normal italic">
              ({product.variant})
            </h3>
            <p>{product.details}</p>
          ...
          <div className="mx-10 mb-5">
            ...
            <div className="flex flex-row">
              {filteredVariants.map((variant) => (
                <Link
                  key={variant._id}
                  href={`/products/${variant.slug.current}`}
                >
      ...
      {/* Shop All */}
      <div className="shopAll flex h-[250px] flex-col items-center justify-center lg:h-[500px]">
